...
$db['default']['password'] = '';
$db['default']['database'] = 'ugod_front';
...
$db['prod']['hostname'] = 'mysql.weareuprising.com';
$db['prod']['username'] = 'uprising_db';
$db['prod']['password'] = 'uprising';
$db['prod']['database'] = 'ugod_three';
